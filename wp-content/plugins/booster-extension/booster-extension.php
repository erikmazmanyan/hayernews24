...
if (!class_exists('Booster_Extension_Class')) {
    ...
    class Booster_Extension_Class{
        ...
        function __construct(){
            ...
            add_action('wp_enqueue_scripts', array($this, 'booster_extension_frontend_scripts'),100);
            ...
            include_once 'inc/frontend/class-svg-icons.php';
            include_once 'inc/frontend/read-later.php';

                ...
                <form class="acft-plugin-settings-form" method="post" action="<?php echo esc_url( admin_url() . 'admin-post.php' )?>">
                    ...
                    <div class="twp-section-tab">
                        <ul class="twp-section-nav-tabs__list">
                            ...
                            <li class="twp-section-nav-tabs">
                                <a id="twp-be-extra-setting" class="twp-be-tab" href="javascript:void(0)"><?php esc_html_e('Extra Settings','booster-extension'); ?></a>
                            </li>
                        </ul>
                    </div>
                    <div class="twp-form-content">
                        ...
                        <div id="twp-be-extra-setting-content" class="twp-be-content">
                            
                            <div class="twp-be-options">
                                <h2 class="booster-control-title">
                                    <span class="booster-core-icons dashicons dashicons-admin-settings"></span> <?php esc_html_e('Posts Settings','booster-extension'); ?>
                                </h2>
                                <div class="twp-be-option-settings">
                                    <?php 
                            ...
                            <div class="twp-be-options">
                                <h2 class="booster-control-title">
                                    <span class="booster-core-icons dashicons dashicons-admin-settings"></span> <?php esc_html_e('Pin Posts Docs','booster-extension'); ?>
                                </h2>
                                <div class="twp-be-option-settings">
                                    
                                    <div class="twp-opt-wrap twp-opt-wrap-info">
                                        <label>
                                            <h4><?php esc_html_e("Shortcode for Bookmark Icon",'booster-extension'); ?></h4>
                                            <code> echo do_shortcode('[be-pp]');</code>

                                            <h4><?php esc_html_e("Shortcode To list Bookmarked Posts",'booster-extension'); ?></h4>
                                            <code> echo do_shortcode('[be-booster-favourites]');</code>

                                            <h4><?php esc_html_e("Filter Before Content",'booster-extension'); ?></h4>
                                            
                                            <code>
                                                booster_extension_before_read_later_post
                                            </code>

                                            <h4><?php esc_html_e("Filter Enable Disable Content",'booster-extension'); ?></h4>
                                            <code>
                                                booster_extension_ed_content
                                            </code>
                                            
                                            <h4><?php esc_html_e("Filter For Contents",'booster-extension'); ?></h4>
                                            <code>
                                                booster_extension_read_later_post_content
                                            </code>

                                            <h4><?php esc_html_e("Filter After Content",'booster-extension'); ?></h4>
                                            <code>
                                                booster_extension_after_read_later_post
                                            </code>

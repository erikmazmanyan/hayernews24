	 ...
	 */
	 class TIE_GOOGLE_WIDGET extends WP_Widget {
		...
		public function __construct(){
			...
			parent::__construct( 'google-widget', apply_filters( 'TieLabs/theme_name', 'TieLabs' ) .' - '. esc_html__( 'Google+ page', TIELABS_TEXTDOMAIN), $widget_ops );
		}
		...
		public function form( $instance ){
			$defaults = array( 'title' => esc_html__( 'Follow us on Google+', TIELABS_TEXTDOMAIN) );
